...
class CC_03_MutexEA{
	...
	volatile static boolean incre_can = true;
	volatile static boolean decre_can = false;
    // ****************************************************************
    
    
    // Sección no crítica
    static void no_sc(int number) {
	...
	public void run () {
		...
		while (!incre_can) {}  //solo a modo de ejemplo
		incre_can = false;     //** NO FUNCIONA **
		// ****************************************
		...
		decre_can=true; // solo a modo de ejemplo
		// *****************************************
	    }
	}
    }
	...
	public void run () {
		...
		// Protocolo de acceso a la sección crítica
		// Añade tu código aquí:
		while (!decre_can) {} // solo a modo de ejemplo
		decre_can = false;    // ** NO FUNCIONA **
		// ****************************************
		...
		// Protocolo de salida de la sección crítica
		// Añade tu código aquí:
		incre_can = true; // solo a modo de ejemplo
		// *****************************************
	    }
	}
    }
